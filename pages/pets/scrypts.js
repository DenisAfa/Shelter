...
(function () {
    ...
    const logoBurgerMenu = document.querySelector(".logo__link");
    burgerItem.addEventListener("click", () => {
        if ( menu.classList.contains( "navbar_active" ) ) {
            ...
            logoBurgerMenu.classList.remove("logo__link_active");
        } else {
            ...
            logoBurgerMenu.classList.add("logo__link_active");
        }
    });
...
const body = document.querySelector("body");
const petsCards = document.querySelectorAll(".content__item");
